...
contract StarNotary is ERC721 {
    ...
    string public name = "Galactic Etoiles Notary";
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        require(bytes(starName).length > 0, "No star with that id");
        return starName;
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(owner1 == msg.sender || owner2 == msg.sender, "You don't own any of the stars");
